...
$CONTACT_WRAPPER['menu']['CONTACT_INFO'] = "<div>{---}</div>";
$CONTACT_WRAPPER['menu']['CONTACT_INFO: type=organization'] = "<h4>{---}</h4>";
$CONTACT_WRAPPER['menu']['CONTACT_INFO: type=message'] = "<p>{---}</p>";
$CONTACT_WRAPPER['menu']['CONTACT_INFO: type=address'] = "<address>{GLYPH=fa-map-marker} {---}</address>";
$CONTACT_WRAPPER['menu']['CONTACT_INFO: type=email1'] = "<div>{GLYPH=fa-envelope} {---}</div>";
$CONTACT_WRAPPER['menu']['CONTACT_INFO: type=email2'] = "<div>{GLYPH=fa-envelope} {---}</div>";
$CONTACT_WRAPPER['menu']['CONTACT_INFO: type=phone1'] = "<div>{GLYPH=fas-phone} {---}</div>";
$CONTACT_WRAPPER['menu']['CONTACT_INFO: type=phone2'] = "<div>{GLYPH=fas-phone} {---}</div>";
$CONTACT_WRAPPER['menu']['CONTACT_INFO: type=phone3'] = "<div>{GLYPH=fas-phone} {---}</div>";
$CONTACT_WRAPPER['menu']['CONTACT_INFO: type=fax'] = "<div>{GLYPH=fa-fax} {---}</div>";
$CONTACT_WRAPPER['menu']['CONTACT_INFO: type=hours'] = "<div>{GLYPH=fa-clock} {---}</div>";
...
$CONTACT_TEMPLATE['menu'] =  '
	...
	<div class="title"><h3>Contactformulier</h3></div>
...
$CONTACT_WRAPPER['menu']['CONTACT_IMAGECODE_INPUT'] 	= "<span class='m-2'>{---}</span></div>";
...
$CONTACT_TEMPLATE['form'] = "
	...
	<form action='".e_SELF."' method='post' id='contactForm' class='mt-1' >
	{CONTACT_PERSON}
...
<div class='col-12 float-start pe-2'> 
	<div class='form-group mb-3'><label for='gdpr'><strong>{LAN=CONTACT_24}</strong></label>
		<div class='checkbox'>
			<label>{CONTACT_GDPR_CHECK} {LAN=CONTACT_21}</label>
			<div class='help-block my-2'>{CONTACT_GDPR_LINK}</div> 
		</div>
	</div>
	</div>	
<div class='col-12 float-start pe-2'> 	
