...
$NAVIGATION_TEMPLATE['main-alt']['start'] = "<div class='navbar-nav {NAV_CLASS}'> <ul class='nav col-12 col-lg-auto justify-content-center my-md-0'>";
$NAVIGATION_TEMPLATE['main-alt']['item'] = "<li><a class='pad nav-link text-secondary ' href='{NAV_LINK_URL}' {NAV_LINK_OPEN} title='{NAV_LINK_DESCRIPTION}'><div class='optionseven object-fit-lg-contain border rounded p-1'><div class='mx-auto' style='width:18px'>
{NAV_LINK_ICON}</div>{NAV_LINK_NAME}</div></a></li>";
$NAVIGATION_TEMPLATE['main-alt']['item_active'] = "<li><a class='pad nav-link link-body-emphasis active' href='{NAV_LINK_URL}' {NAV_LINK_OPEN} title='{NAV_LINK_DESCRIPTION}'><div class='optionseven object-fit-lg-contain border rounded p-1'><div class='mx-auto' style='width:18px'>
{NAV_LINK_ICON}</div>{NAV_LINK_NAME}</div></a></li>";
$NAVIGATION_TEMPLATE['main-alt']['end'] = '</ul></div>';
...
$NAVIGATION_TEMPLATE['footer']['item'] = "<li class='nav-item'>
 <a class='nav-link px-2 text-body-secondary' href='{NAV_LINK_URL}' {NAV_LINK_OPEN} title='{NAV_LINK_DESCRIPTION}'>{NAV_LINK_ICON}{NAV_LINK_NAME}</a></li>";
$NAVIGATION_TEMPLATE['footer']['item_active'] = "<li class='nav-item active' {NAV_LINK_OPEN}>
	<a class='nav-link px-2 text-body-secondary active' href='{NAV_LINK_URL}' title='{NAV_LINK_DESCRIPTION}'>{NAV_LINK_ICON}{NAV_LINK_NAME}</a></li>";
