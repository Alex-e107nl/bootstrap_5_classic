...
// Default
$NEWS_VIEW_WRAPPER['default']['item']['NEWSIMAGE: item=1'] = '<span class="news-images-main pull-left float-left float-start col-sm-12 col-md-12 me-3 mb-3">{---}</span>';
...
{SETIMAGE: w=1280&h=853}

	<div class="view-item">
          	<div class="row">
        		<div class="col-md-6 text-secondary"><small>{GLYPH=user} &nbsp;{NEWSAUTHOR} &nbsp; {GLYPH=clock} &nbsp;{NEWSDATE=short} </small></div>
        		<div class="col-md-6 text-right text-end options text-secondary"><small>{GLYPH=tags} &nbsp;{NEWSTAGS} &nbsp; {GLYPH=folder-open} &nbsp;{NEWSCATEGORY} </small></div>
        	</div>
        <hr>
