...
$NEWS_TEMPLATE['list']['start']	= '{SETIMAGE: w=800&h=600&crop=1}';
/*
 // (optional)
...
$NEWS_TEMPLATE['list']['item']	= '
		...
		<div class="row row-fluid">
				...
				<div class="span9 col-md-9">
                   <h4 class="media-heading">{NEWS_TITLE: link=1&class=text-body-secondary}</h4>
                      <p>
                       	{NEWS_SUMMARY}
					</p>
                    <p>
...
$NEWS_WRAPPER['default']['item']['NEWSIMAGE: item=1'] = '<span class="news-images-main pull-left float-left col-xs-12 col-sm-12 col-md-12">{---}</span>';

$NEWS_TEMPLATE['default']['caption'] = null; // add a value to user tablerender()
$NEWS_TEMPLATE['default']['start']	= '<!-- Default News Template -->';
$NEWS_TEMPLATE['default']['item'] = ' {SETIMAGE: w=800&h=600&crop=1}
		<div class="row row-fluid">
				<div class="span3 col-md-3">
                   <div class="thumbnail">
                        {NEWSTHUMBNAIL=placeholder}
...
$NEWS_TEMPLATE['related']['item']       = '<div class="col-md-3 col-lg-2 text-center"><a href="{RELATED_URL}">{RELATED_IMAGE}</a><h6><a href="{RELATED_URL}">{RELATED_TITLE}</a></h6></div>';
