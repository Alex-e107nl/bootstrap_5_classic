...
// New Template for v2. Bullets via CSS etc. Login-Menu Stats may require work. 
    ...
    $sc_style['LM_STATS']['pre'] = '<li class="list-group-item nav-header login-menu-stats smalltext">'.LAN_LOGINMENU_25.':</li><li class="list-group-item login-menu-stats smalltext">';
