...
$SIGNUP_WRAPPER['SIGNUP_DISPLAYNAME'] = 		"<div class='form-group row m-2'>
													<label class='col-sm-4 control-label' for='username'>{LAN=SIGNUP_89}{SIGNUP_IS_MANDATORY=true}<br /><span class='smalltext'>{LAN=SIGNUP_90}</span></label>
													<div class='col-sm-8'>{---}</div>
												</div>";

$SIGNUP_WRAPPER['SIGNUP_REALNAME'] = 			"<div class='form-group row m-2'>
													<label class='col-sm-4 control-label' for='realname'>{LAN=SIGNUP_91}{SIGNUP_IS_MANDATORY=realname}</label>
													<div class='col-sm-8'>{---}</div>
												</div>";
...
$SIGNUP_WRAPPER['SIGNUP_SIGNATURE'] = 			"<div class='form-group row m-2'>
													<label class='col-sm-4 control-label' for='signature'>{LAN=SIGNUP_93}{SIGNUP_IS_MANDATORY=signature}</label>
													<div class='col-sm-8'>{---}</div>
												</div>";

$SIGNUP_WRAPPER['SIGNUP_IMAGES'] = 				"<div class='form-group row m-2'>
													<label class='col-sm-4 control-label'for='avatar'>{LAN=SIGNUP_94}{SIGNUP_IS_MANDATORY=avatar}</label>
													<div class='col-sm-8'>{---}</div>
												</div>";

$SIGNUP_WRAPPER['SIGNUP_IMAGECODE'] = 			"<div class='form-group row m-2'>
													<label class='col-sm-4 control-label' for='code-verify'>" . e107::getSecureImg()->renderLabel()."{SIGNUP_IS_MANDATORY=true}</label>
													<div class='col-sm-8'>{---}</div>
												</div>";

$SIGNUP_WRAPPER['SIGNUP_LOGINNAME'] = 			"<div class='form-group row m-2'>
													<label class='col-sm-4 control-label' for='loginname'>{LAN=SIGNUP_81}{SIGNUP_IS_MANDATORY=true}</label>
													<div class='col-sm-8'>{---}</div>
												</div>";

$SIGNUP_WRAPPER['SIGNUP_HIDE_EMAIL'] = 			"<div class='form-group row m-2'>
													<label class='col-sm-4 control-label'>{LAN=USER_83}</label>
													<div class='col-sm-8'>{---}</div>
												</div>";

$SIGNUP_WRAPPER['SIGNUP_EMAIL_CONFIRM'] = 		"<div class='form-group row m-2'>
													<label class='col-sm-4 control-label' for='email-confirm'>{LAN=SIGNUP_39}{SIGNUP_IS_MANDATORY=true}</label>
													<div class='col-sm-8'>{---}</div>
												</div>";
...
$SIGNUP_WRAPPER['SIGNUP_PASSWORD1'] = 			"<div class='form-group row m-2'>
													<label class='col-sm-4 control-label' for='password1'>{LAN=SIGNUP_83}{SIGNUP_IS_MANDATORY=true}</label>
													<div class='col-sm-8'>{---}</div>
												</div>";

$SIGNUP_WRAPPER['SIGNUP_PASSWORD2'] = 			"<div class='form-group row m-2'>
													<label class='col-sm-4 control-label' for='password2'>{LAN=SIGNUP_84}{SIGNUP_IS_MANDATORY=true}</label>
													<div class='col-sm-8'>{---}</div>
												</div>";

$SIGNUP_WRAPPER['SIGNUP_USERCLASS_SUBSCRIBE'] = "<div class='form-group row m-2 '>
													<label class='col-sm-4 control-label'>{LAN=SIGNUP_113}{SIGNUP_IS_MANDATORY=subscribe}</label>
													<div class='col-sm-8 checkbox'>{---}</div>
												</div>";
	...
	<div id='default'>
		{SIGNUP_XUP_ACTION}
			...
			<div class='form-group row m-2'>
				<label class='col-sm-4 control-label' for='password1'>{LAN=LAN_USER_60}{SIGNUP_IS_MANDATORY=email}</label>
				<div class='col-sm-8'>{SIGNUP_EMAIL}</div>
			</div>
...
$SIGNUP_TEMPLATE['extended-category']       = "
											<div class='form-group row m-2'>
												<div class='col-sm-8 col-md-offset-3'>{EXTENDED_CAT_TEXT}</div>
											</div>";

$SIGNUP_TEMPLATE['extended-user-fields']    = "
											<div class='form-group row m-2'>
												<label class='col-sm-4 control-label'>{EXTENDED_USER_FIELD_TEXT}{EXTENDED_USER_FIELD_REQUIRED}</label>
												<div class='col-sm-8'>{EXTENDED_USER_FIELD_EDIT}</div>
											</div>";