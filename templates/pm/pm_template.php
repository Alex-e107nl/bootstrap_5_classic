...
<tr>
	...
	<th class='fcaption' style='width:150px'>{PM_COMPOSE: class=block-level}</th>
</tr>
</thead>
	<tbody>
";
...
//$PM_SHOW =
$PM_TEMPLATE['show'] =
"<div class='pm-show' style='text-align: left'>
<table class='table table-bordered table-striped fborder'>
<tr>
	<td class='fcaption text-left'>
	<h3>{PM_SUBJECT} <small class='pull-right float-right float-end fs-6'>{PM_DATE}</small></h3>
	<small>{PM_FROM_TO}</small>
	<small class='pull-right float-right float-none'>{PM_READ}</small>
	<small class='pull-right float-right float-end'>{PM_DELETE}</small></td>
</tr>
<tr>
