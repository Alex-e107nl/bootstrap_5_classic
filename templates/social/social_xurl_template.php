<?php
	 ...
	 */
	 ...
	 $SOCIAL_XURL_TEMPLATE['footer']['item'] = '<a target="_blank" rel="noopener noreferrer" href="{XURL_ICONS_HREF}" data-tooltip-position="top" class="e-tip social-icon social-{XURL_ICONS_ID}" title="{XURL_ICONS_TITLE}" aria-label="{XURL_ICONS_TITLE}"><span class="e-social-{XURL_ICONS_ID} {XURL_ICONS_CLASS}"></span></a>';
